...
- (void) setupAlertView {
  ...
  _alertMessageTextView = [[UITextView alloc]
                           initWithFrame:CGRectMake(0,
                                                    _alertView.frame.size.height * 0.2,
                                                    _alertView.frame.size.width,
                                                    _alertView.frame.size.height
                                                    - alertTitlePadding - buttonPadding)];
...
sourceViewController:(UIViewController *)source {
  ...
  FXPresentationController *fxPresentationController = [[FXPresentationController alloc]
...
- (void) sizeAlert {
  ...
  CGFloat totalAlertViewHeight = _alertTitleLabel.frame.size.height +
  _alertMessageTextView.frame.size.height + buttonPadding;
...
- (CGRect)cancelButtonRect {
  ...
  return CGRectMake(self.alertView.frame.size.width * 0.5, self.alertView.frame.size.height - height,
                    buttonWidth, height);
}
@end